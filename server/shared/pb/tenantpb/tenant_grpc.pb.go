...
const (
	TenantService_CreateTenant_FullMethodName         = "/learnhub.tenant.v1.TenantService/CreateTenant"
	TenantService_GetTenant_FullMethodName            = "/learnhub.tenant.v1.TenantService/GetTenant"
	TenantService_UpdateTenantSettings_FullMethodName = "/learnhub.tenant.v1.TenantService/UpdateTenantSettings"
)
...
type TenantServiceClient interface {
	...
	UpdateTenantSettings(ctx context.Context, in *UpdateTenantSettingsRequest, opts ...grpc.CallOption) (*TenantResponse, error)
}
...
func (c *tenantServiceClient) UpdateTenantSettings(ctx context.Context, in *UpdateTenantSettingsRequest, opts ...grpc.CallOption) (*TenantResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TenantResponse)
	err := c.cc.Invoke(ctx, TenantService_UpdateTenantSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TenantService_UpdateTenantSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_UpdateTenantSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "learnhub.tenant.v1.TenantService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TenantService_UpdateTenantSettings_Handler,
		},
	},
