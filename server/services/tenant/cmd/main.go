...
func main() {
	...
	handler := tenant.NewHandler(repo)
	...
	tenantpb.RegisterTenantServiceServer(grpcServer, handler)
	reflection.Register(grpcServer)

	go func() {
		log.Info().Str("port", cfg.Port).Msg("Tenant Service gRPC server listening")
